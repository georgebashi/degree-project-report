...
my $versionnumber=1.7;
my $versiondate="2006 Jul 2";
...
# no tokens are excluded, by [...] options are. Some macros
# have been included here with =>0 for completeness and as a
# reminder.
my %TeXexcl=('\documentclass'=>1,'\documentstyle'=>1,
     '\usepackage'=>1, '\hyphenation'=>1,
     '\pagestyle'=>1,'\thispagestyle'=>1, '\pagenumbering'=>1,
     '\markboth'=>1, '\markright'=>1,
     '\newcommand'=>2,'\renewcommand'=>2,
     '\newenvironment'=>3, 'renewenvironment'=>3,
     '\newtheorem'=>2,
     '\parbox'=>1, '\marginpar'=>0,
     '\makebox'=>0, '\raisebox'=>1, '\framebox'=>0,
     '\newsavebox'=>1, '\sbox'=>1, '\savebox'=>2, '\usebox'=>1,
     '\rule'=>2,
     '\label'=>1, '\ref'=>1, '\pageref'=>1, '\bibitem'=>1,
     '\cite'=>1, '\citep'=>1, '\citet'=>1, '\nocite'=>1,
     '\eqlabel'=>1, '\eqref'=>1,
     '\hspace'=>1, '\vspace'=>1, '\addvspace'=>1,
     '\input'=>1, '\include'=>1, '\includeonly'=>1,
     '\bibliographystyle'=>1, '\bibliography'=>1,
     '\newlength'=>1, '\setlength'=>2, '\addtolength'=>2,
     '\settodepth'=>2, '\settoheight'=>2, '\settowidth'=>2,
     '\newcounter'=>1, '\setcounter'=>2, '\addtocounter'=>2,
     '\stepcounter'=>1, '\refstepcounter'=>1, '\usecounter'=>1,
     '\alph'=>1, '\arabic'=>1, '\fnsymbol'=>1, '\roman'=>1, '\value'=>1,
     '\newfont'=>2,
     '\cline'=>1, '\multicolumn'=>3,
     '\typeout'=>1, '\typein'=>1,
     'beginlist'=>2, 'beginminipage'=>1, 'begintabular'=>1,
     'beginthebibliography'=>1,
     'beginlrbox'=>1 );
...
my %TeXgroup=('document'=>1,'letter'=>1,'titlepage'=>0,
     ...
     'abstract'=>0,'quote'=>0,'quotation'=>0,'verse'=>1,
     'minipage'=>1,'verbatim'=>1,
     'description'=>1,'enumerate'=>1,'itemize'=>1,'list'=>1,
     'theorem'=>1,'lemma'=>1,'definition'=>1,'corollary'=>1,
     'example'=>1,
     'math'=>6,'displaymath'=>7,
     'equation'=>7,'eqnarray'=>7,
     'figure'=>-1,'float'=>-1,'picture'=>-1,'table'=>-1,
     'tabbing'=>0,'tabular'=>0,'thebibliography'=>0,
     'lrbox'=>0);
...
my @countlabel=('Files','Words in text','Words in headers',
                'Words in float captions','Number of headers',
                'Number of floats',
...
#VERSION
if ($ARGV[0]=~/^\-\-version$/) {
  print "Version ".$versionnumber.", ".$versiondate.'.';
  exit;
}
...
sub TeXfile {
  my $filename=shift @_;
  return TeXcode(read_file($filename));
}
...
unless explicitly recognized as text or mathematics.
