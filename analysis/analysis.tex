...
The first research requirement of providing verifiability and review was achieved by providing a binary file viewer and verbose output options. \executable{generator} prints scores used in the similarity metric that proved valuable in testing, allowing analysis of any anomolous tracks in the playlist.
